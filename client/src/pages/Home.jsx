    ...
    <>
      <div className="presentation">
        ...
        <p className="description-site">
          ...
          cinématographiques préférées.
          <br /> Inspiré par The Movie Database (TMDB), Moovies Lib offre une
          interface utilisateur élégante et intuitive qui permet aux cinéphiles
          de naviguer facilement à travers une vaste base de données de films et
          de séries TV.
        </p>
      </div>
